...
(function($) {
    ...
    function imgproxy_thumb(url, width) {
        if (!url) return url;
    ...
    function render_results(data){
        ...
        $.each(data.hits, function(k, v) {
            var i=0;
            if(v.multi_img) {
                image_item += '<div class="item itemid'+v.import_source_id+' upload multiimg'+(v.exists===2?' exists':(v.exists?' existsp':''))+'" data-title="'+v.title+'" data-wpnonce="'+v.wpnonce+'" data-url="'+imgproxy_thumb(v.largeImageURL, upload_size)+'" data-invnr="'+v.inv_nr+'" data-artist="'+v.name_artist+'" data-import_source_id="'+v.import_source_id+'" data-image_id="'+v.imageId+'" data-import_inventory_id="'+v.import_inventory_id+'" data-caption="'+v.caption+v.photocredit+'" data-description="'+v.description+'" data-alt="'+v.alt+'" data-w="'+v.webformatWidth+'" data-h="'+v.webformatHeight+'">'
                    +'<img src="'+imgproxy_thumb(v.previewURL, thumb_size)+'" title="#'+v.inv_nr+'" alt="#'+v.inv_nr+'">'
                    +'<div class="dlimg">'
                ...
                image_item += '<div class="item subitem itemid'+v.import_source_id+' subitemid'+v.import_source_id+' upload multiimg hidden ender" data-w="165" data-h="1000" data-import_source_id="'+v.import_source_id+'">'
                    +'<img src="'+imgproxy_thumb(v.previewURL, thumb_size)+'" style="display:none !important;">'
                    +'<div class="dlimg">'
                ...
                image_item += '<div class="item upload'+(v.exists?' exists':'')+'" data-title="'+v.title+'" data-wpnonce="'+v.wpnonce+'" data-url="'+imgproxy_thumb(v.largeImageURL, upload_size)+'" data-invnr="'+v.inv_nr+'" data-artist="'+v.name_artist+'" data-import_source_id="'+v.import_source_id+'" data-image_id="'+v.imageId+'" data-import_inventory_id="'+v.import_inventory_id+'" data-caption="'+v.caption+v.photocredit+'" data-description="'+v.description+'" data-alt="'+v.alt+'" data-w="'+v.webformatWidth+'" data-h="'+v.webformatHeight+'">'
                    +'<img src="'+imgproxy_thumb(v.previewURL, thumb_size)+'" title="#'+v.inv_nr+'" alt="#'+v.inv_nr+'">'
                    +'<div class="dlimg">'
                        +'<img src="/../wp-content/plugins/wrklst-plugin/assets/img/round-cloud_download-24px.svg">'
                        +'<div class="caption">'+v.title+'</div>'
